...
class Android_ATP_WTA(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'HUAWEI Y7 Pro 2018'
        # Since the app is already installed launching it using package and activity name
        desired_caps['appPackage'] = 'com.cba.payable'
        desired_caps['appActivity'] = 'com.cba.payable.Launcher'
    ...
    def test_atp_wta(self):
        ...
        Account = self.driver.find_element(By.XPATH("android.widget.TextView[contains(@text,'Account')]"))
        Account.click()
    ...
    if __name__ == '__main__':
        suite = unittest.TestLoader().loadTestsFromTestCase(test_atp_wta)
